...
class EvalManager(object):
    ...
    def report(self):
        ...
        self.GravarArquivo(self.percentageData,self.ArrarQuestoesErradas,"questaoErrada")
        self.GravarArquivo(self.percentageData,self.ArrayQuestoesCertas,"questaoCerta")

       

    def GravarArquivo (self,percentageData, data_dict,fname):
...
class Evaler(object):
    ...
    def eval_run(self):
        ...
        evaler = EvalManager(self.dataset)
        try:
